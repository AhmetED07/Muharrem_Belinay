...
let prefix = ayarlar.prefix;
  ...
  const botbilgi = new Discord.MessageEmbed()
    .setAuthor(`Muharrem Belinay | Discord Bot Bilgi Tablosu`)
    .setTitle(``)
    .setColor("#00ff00")
    .setImage('https://cdn.discordapp.com/attachments/1108819464524415097/1109034877774483466/standard_7.gif')
    .setThumbnail(client.user.avatarURL())
    .setDescription(
      `📯 Muharrem Belinay Botumuzu Eklemek İçin \`${prefix}davet\` yazabilirsiniz.`
    )
    .addField(
      "__**Bot Verileri**__",
      `📗 **Toplam Sunucu** **|**  \`${
    ...
    .addField(
      "__**Yetkili Bilgi**__",
      "👑 **Bot Sahipleri**  <@696064653465354259> \n\n"
    )
    .addField(
      "__**Sürümler**__",
