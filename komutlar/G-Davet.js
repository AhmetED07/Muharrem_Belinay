...
exports.run = async (client, message) => {
  ...
  const fynxcode = new Discord.MessageEmbed()
    .setColor("#00ff00")
    .setAuthor(`Muharrem Belinay Davet Menü`)
    .setDescription(
      `**💼 Botun Davet Linki [TIKLA](https://discord.com/api/oauth2/authorize?client_id=1139123026663841793&permissions=8&scope=bot)**\n`
    )
    .addField(
      `__Bilgilendirme__`,
